...
parser = parser_singledevice("Graph-guided fused lasso, FB splitting-based iterations.")
...
kappas =[-1, -0.1, -0.5, 0]
expr_names = ['ggfl_base_cv', 'ggfl_base_01', 'ggfl_base_05', 'ggfl_base_lv']
...
with tf.Session() as sess:
    for param, kappa, expr_name in zip(params, kappas, expr_names):
        tau, sigma, rho = param
        prob = dist_pd.primal_dual.BaseKappa(loss, penalty, At, D_dist, b, aggregate=False, 
