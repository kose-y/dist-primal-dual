...
parser = parser_singledevice("Graph-guided fused lasso, optimal-rate iteration.")
...
expr_names = ['ggfl_bdd_lv', 'ggfl_bdd_half', 'ggfl_bdd_cv', 'ggfl_unbdd_chen', 'ggfl_unbdd_lv', 'ggfl_unbdd_half', 'ggfl_unbdd_cv']
